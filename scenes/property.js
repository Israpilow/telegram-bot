...
doneStep.action('send', async (ctx) => {
    ...
    await ctx.telegram.sendMessage(1722633425, `<b>КВАРТИРЫ</b>\n\n<b>${wizardData.photo}</b>`, {
        parse_mode: "HTML"
    });
...
const propertyScene = new Scenes.WizardScene('propertyWizard', startStep, photoStep, botStep, doneStep);
